...
namespace Lawn
{
    public/*internal*/ class Projectile : GameObject
    {
        ...
        {
            if (mProjectileType == ProjectileType.Pea || mProjectileType == ProjectileType.Snowpea || mProjectileType == ProjectileType.ZombiePea || mProjectileType == ProjectileType.ZombieFirepea || mProjectileType == ProjectileType.ZombiePeaMindControl)
            {
        ...
        {
            return (mProjectileType != ProjectileType.Fireball || mProjectileType != ProjectileType.BlueFire || theZombie == null || !theZombie.IsFireResistant()) && (mProjectileType == ProjectileType.Melon || mProjectileType == ProjectileType.Wintermelon || mProjectileType == ProjectileType.Fireball || mProjectileType == ProjectileType.BlueFire);
        }
