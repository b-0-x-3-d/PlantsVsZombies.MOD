...
namespace Lawn
{
    public/*internal*/ class Plant : GameObject
    {
        ...
        public void Fire(Zombie theTargetZombie, int theRow, PlantWeapon thePlantWeapon)
        {
            ...
            if (mSeedType == SeedType.Cabbagepult || mSeedType == SeedType.Kernelpult || mSeedType == SeedType.Melonpult || mSeedType == SeedType.Wintermelon || mSeedType == SeedType.Lobbashroom)
            {
                float num12;
                float num13;
        ...
        public void UpdateAbilities()//3update
        {
            ...
            else if (mSeedType == SeedType.Repeater)
            {
                UpdateTorchwood();
            }
        ...
        public int GetDamageRangeFlags(PlantWeapon thePlantWeapon)
        {
            ...
            else
            {
                ...
                if (mSeedType == SeedType.Melonpult || mSeedType == SeedType.Lobbashroom || mSeedType == SeedType.Cabbagepult || mSeedType == SeedType.Kernelpult || mSeedType == SeedType.Wintermelon)
                {
                    return 13;
                }
                if (mSeedType == SeedType.Potatomine)
