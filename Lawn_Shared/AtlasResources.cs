...
public/*internal*/ class AtlasResources
{
    ...
    public static Image GetImageInAtlasById(int theId)
    {
        ...
        case 30003:
            return AtlasResources.IMAGE_REANIM_METEOR1;
        case 30004:
            return AtlasResources.IMAGE_REANIM_METEOR2;
        default:
    ...
    public static int GetIdByImageInAtlas(Image theImage)
    {
        ...
        if (theImage == AtlasResources.IMAGE_REANIM_METEOR1)
        {
            return 20004;
        }
        if (theImage == AtlasResources.IMAGE_REANIM_METEOR2)
        {
            return 20005;
        }
    ...
    public static Image IMAGE_REANIM_METEOR1;

    public static Image IMAGE_REANIM_METEOR2;
    ...
    private static AtlasResources.AtlasStringTable[] table = new AtlasResources.AtlasStringTable[]
    {
        ...
        new AtlasResources.AtlasStringTable("IMAGE_REANIM_METEOR1", 30003),
        new AtlasResources.AtlasStringTable("IMAGE_REANIM_METEOR2", 30004)
    };
    ...
    public enum AtlasImageId
    {
        ...
        IMAGE_REANIM_METEOR1_ID,
        IMAGE_REANIM_METEOR2_ID,
